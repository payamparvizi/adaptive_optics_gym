...
This code corresponds to our MPDI Photonics publication. The related paper can be found [GitHub Pages](https://pages.github.com/). It includes a simulated environment for satellite communications downlinks, used to train reinforcement learning models for controlling a deformable mirror within a wavefront sensorless Adaptive Optics system.
