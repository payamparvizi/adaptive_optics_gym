...
This code corresponds to our MPDI Photonics publication. The related paper can be found [here](https://doi.org/10.3390/photonics10121371). It includes a simulated environment for satellite communications downlinks, used to train reinforcement learning models for controlling a deformable mirror within a wavefront sensorless Adaptive Optics system.
...
```
@inproceedings{parvizi2023reinforcement,
